            ...
            new Chart(lineCanvas, {
                ...
                options: {
                    ...
                    scales: {
                        x: {
                            ticks: { color: "white" },
                            grid: { color: "rgba(228, 235, 238, 0.1)" }
                        },
                        y: {
                            ticks: { color: "white" },
                            grid: { color: "rgba(228, 221, 221, 0.1)" }
                        }
                    }
                }
            });
...
const nestedChart = new Chart(ctx, {
    type: 'doughnut',
    data: {
